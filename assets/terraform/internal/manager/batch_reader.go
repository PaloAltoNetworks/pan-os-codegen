...
func ExtractNames[E Entry](entries []E) []string {
	var names []string
...
func FilterEntriesByLocation[E EntryWithAttributes, L LocationLike](ctx context.Context, location L, entries []E) []E {
...
type BatchReader[E Entry, S ServiceWithListXpath[E]] struct {
	service        S
	batchingConfig BatchingConfig
}

// NewBatchReader creates a new batch reader
func NewBatchReader[E Entry, S ServiceWithListXpath[E]](
	service S,
	batchingConfig BatchingConfig,
) *BatchReader[E, S] {
